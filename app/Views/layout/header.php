...
$nomeClinica = TenantResolver::$empresa['nome'] ?? $_SESSION['empresa_nome'] ?? APP_NAME;
?><!DOCTYPE html>
<html lang="pt-BR">
<head>
    <meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1.0">
    <title><?=htmlspecialchars($nomeClinica)?></title>
    <link rel="stylesheet" href="<?=BASE_URL?>public/assets/css/style.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    <script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
    <style>
    .faixa-suporte{background:#FF6B2B;color:#fff;text-align:center;padding:.5rem 1rem;
      font-size:.82rem;font-weight:600;display:flex;align-items:center;justify-content:center;gap:.6rem;}
    .faixa-suporte a{color:#fff;text-decoration:underline;font-weight:700;}
    </style>
</head>
<body>
<?php if (!empty($_SESSION['suporte_via_super_admin'])): ?>
<div class="faixa-suporte">
  <i class="fa fa-user-secret"></i>
  Você está vendo o sistema como suporte (dentro de <?=htmlspecialchars($nomeClinica)?>).
  <a href="<?=BASE_URL?>sair-modo-suporte">Voltar ao Super Admin</a>
</div>
<?php endif; ?>
<header class="navbar">
    <div class="logo"><a href="<?=BASE_URL?>dashboard" style="text-decoration:none;color:inherit;">🦷 <?=htmlspecialchars($nomeClinica)?></a></div>
    <?php if(is_logado()):?>
    ...
    <?php if(is_logado()):?>
    <div class="user-menu"><a href="<?=BASE_URL?>logout" class="btn btn-secondary"><i class="fa fa-sign-out"></i> Sair</a></div>
    <?php endif;?>
</header>
<script>
